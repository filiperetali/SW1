...
<body>
    <h1>Atividade dia 06/04/2022</h1>
    <ol>
        <li>Importar banco de dados de exemplo</li>
        <li>Utilizar o codígo disponibilizado em</li>
        <ul><li><h1>github.com/filiperetali/php</h1></li></ul>

</ol>
    <h1>Criar:</h1>
    <ol>
        <li>Novo formulário de empresas</li>
        <li>Criar cada um dos arquivos conforme aulas anteriores</li>
    </ol>
